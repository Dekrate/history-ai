...
public class HistoricalCharacterDTO {
     ...
     * Note: ID is intentionally not transferred - it's generated by @PrePersist.
     * For UPDATE operations, use service.update() which fetches existing entity.
     *
     * @return new HistoricalCharacter entity without ID
     */
